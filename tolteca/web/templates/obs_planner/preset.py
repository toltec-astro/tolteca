...
class PresetDataItem(object):
    ...
    value_min: object = field(default=None, metadata={"description": "minimum value."})
    value_max: object = field(default=None, metadata={"description": "maximum value."})
    unit: str = field(
        default=None,
        metadata={
    ...
    label: str = field(
        default=None, metadata={"description": "The label to display instead of key."}
    )
    description: str = field(
        default=None, metadata={"description": "The description of the data item."}
    )
    ...
    component_kw: dict = field(
        ...
        metadata={"description": "Additional kwargs passed to the component."},
    )
...
class Preset(object):
    ...
    conditions: dict = field(
        default_factory=dict,
        metadata={
            "description": "The dict of conditions for this to be enabled",
        },
    )
    description: str = field(
        default=None,
...
class PresetsConfig(DataclassNamespace):
    ...
    _namespace_from_dict_schema = Schema(
        {Literal("presets", description="The presets list."): [Preset.schema]}
    )
    ...
    def __init__(self, **kwargs):
        ...
        self._presets_by_uid = odict_from_list(self.presets, key=lambda x: x.unique_id)
        self._presets_by_type = odict_from_list(self.presets, key=lambda x: x.unique_id)
