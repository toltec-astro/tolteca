...
dark=False, hover=True, responsive=True,striped=True,width=100)
        ...
        def update_a1100(obsnum,value,checklist,clickData_h0,clickData_h1,clickData_h2,
                         clickData_h3,clickData_h4):
            ...
            x = np.array(p[value[0]])
            y = np.array(p[value[1]])
        ...
        def update_b1100(clickData,checklist,clickData_h0,clickData_h1,clickData_h2,
            ...
            try:
                print('clickData_f',clickData_h4['range']['x'])
                amp_temp = np.array(p['fwhmy'])
                ai = np.where((amp_temp>=clickData_h4['range']['x'][0]) & (amp_temp<=clickData_h4['range']['x'][1]))[0]
            except:
                ai = list(range(len(p['fwhmy'])))
...
dark=False, hover=True, responsive=True,striped=True,width=100)
        ...
        def update_a1400(obsnum,value,checklist,clickData_h0,clickData_h1,clickData_h2,
                         clickData_h3,clickData_h4):
            #Lists for the x,y, and color
            x = []
            y = []
...
dark=False, hover=True, responsive=True,striped=True,width=100)
        ...
        def update_a2000(obsnum,value,checklist,clickData_h0,clickData_h1,clickData_h2,
                         clickData_h3,clickData_h4):
            #Lists for the x,y, and color
            x = []
            y = []
