...
"""This module implements the base KidsData class."""
...
__all__ = ['TimeSeriesData', 'nc_kidsdata_reader', 'nc_kidsdata_writer']
...
# if the unit is None!
_config_kids_requires_unit = True


def _uncertainty_unit_equivalent_to_parent(
        uncertainty_type, unit, parent_unit):
...
class KidsData(NDDataRef):
    """A class describing basic Kids data.
    The KidsData class is based on the NDData object and includes a data array,
    uncertainty frame, mask frame, flag frame, meta data, units, and WCS
    information for data collected by KIDs.
    Parameters
    -----------
